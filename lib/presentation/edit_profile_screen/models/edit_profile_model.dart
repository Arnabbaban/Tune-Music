import 'package:get/get.dart';import 'package:tune_music/data/models/selectionPopupModel/selection_popup_model.dart';class EditProfileModel {Rx<DateTime>? selectedDateTxt = Rx(DateTime.now());
